...
<div class="p-4">
    <div class="flex items-start gap-3 mb-3">
        ...
        <div class="flex-1">
            <h3 class="text-lg font-semibold text-gray-900 group-hover:text-green-600 transition-colors line-clamp-1">
                {{ $shop->name }}
            </h3>
    ...
    <div class="flex gap-2">
        <a href="{{ route('shops.show', $shop->slug) }}"
            class="flex-1 bg-green-600 text-white py-2 px-4 rounded-lg font-medium hover:bg-green-700 transition-colors flex items-center justify-center gap-2 text-sm">
            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="https://wa.me/{{ $shop->phone ?? '6288225292279' }}?text={{ urlencode('Halo ' . $shop->name . ', saya tertarik dengan produk-produk di toko Anda.') }}"
            target="_blank" class="bg-green-500 text-white p-2 rounded-lg hover:bg-green-600 transition-colors"
